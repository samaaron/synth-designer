...
export default class LoFi extends BleepEffect {
    ...
    constructor(context, monitor) {
        ...
        this.#crusher = new MonitoredWaveShaperNode(context, monitor, {
            curve: this.#createBitCrusherCurve(LoFi.DEFAULT_BITS)
        });
        // connect
        this._wetGain.connect(this.#crusher);
        this.#crusher.connect(this._out);
        // set defaults
        this.setWetLevel(LoFi.DEFAULT_WET_LEVEL);
        this.setDryLevel(LoFi.DEFAULT_DRY_LEVEL);
    }

    /**
     * create a quantisation curve for lofi
